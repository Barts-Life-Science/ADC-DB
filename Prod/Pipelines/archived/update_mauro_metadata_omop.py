...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE 1_inland.evan_demo.mauro_metadata_col_omop(
...
# MAGIC )
# MAGIC INSERT INTO 1_inland.evan_demo.mauro_metadata_col_omop
# MAGIC SELECT 
...
# MAGIC %sql
# MAGIC
# MAGIC MERGE INTO 1_inland.evan_demo.mauro_metadata_col_omop AS target
# MAGIC USING (
# MAGIC   SELECT 
# MAGIC     table_name,
# MAGIC     column_name, 
...
# MAGIC   FROM 1_inland.evan_demo.mauro_metadata_col_omop
# MAGIC   WHERE
# MAGIC     (
# MAGIC       table_catalog = '4_prod'
# MAGIC       AND table_schema = 'dlt'
...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE TABLE 1_inland.evan_demo.mauro_metadata_tab_omop(
...
# MAGIC %sql
# MAGIC INSERT INTO 1_inland.evan_demo.mauro_metadata_tab_omop
# MAGIC SELECT
# MAGIC   c.table_name,
# MAGIC   NULL,
...
# MAGIC FROM 1_inland.evan_demo.mauro_metadata_col_omop AS c
...
# MAGIC %sql
# MAGIC
# MAGIC MERGE INTO 1_inland.evan_demo.mauro_metadata_tab_omop AS target
# MAGIC USING (
...
from 1_inland.evan_demo.mauro_metadata_tab_omop
""")

# COMMAND ----------

df.write.mode("overwrite").json("/Volumes/1_inland/sectra/vone/tmp.json")
