...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE 1_inland.evan_demo.mauro_metadata_col_mill(
...
# MAGIC )
# MAGIC INSERT INTO 1_inland.evan_demo.mauro_metadata_col_mill
# MAGIC SELECT 
...
# MAGIC %sql
# MAGIC
# MAGIC MERGE INTO 1_inland.evan_demo.mauro_metadata_col_mill AS target
# MAGIC USING (
# MAGIC   SELECT 
# MAGIC     table_name,
# MAGIC     column_name, 
...
# MAGIC   FROM 1_inland.evan_demo.mauro_metadata_col_mill
# MAGIC   WHERE
# MAGIC   (
...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE TABLE 1_inland.evan_demo.mauro_metadata_tab_mill(
...
# MAGIC %sql
# MAGIC INSERT INTO 1_inland.evan_demo.mauro_metadata_tab_mill
# MAGIC SELECT
# MAGIC   c.table_name,
# MAGIC   NULL,
...
# MAGIC FROM 1_inland.evan_demo.mauro_metadata_col_mill AS c
...
# MAGIC %sql
# MAGIC
# MAGIC MERGE INTO 1_inland.evan_demo.mauro_metadata_tab_mill AS target
# MAGIC USING (
...
from 1_inland.evan_demo.mauro_metadata_tab_mill
""")

# COMMAND ----------

df.write.mode("overwrite").json("/Volumes/1_inland/sectra/vone/mill_mauro.json")
