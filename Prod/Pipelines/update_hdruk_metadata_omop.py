...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE 1_inland.evan_demo.hdruk_metadata_col_omop(
...
# MAGIC )
# MAGIC INSERT INTO 1_inland.evan_demo.hdruk_metadata_col_omop
# MAGIC SELECT 
...
# MAGIC %sql
# MAGIC
# MAGIC MERGE INTO 1_inland.evan_demo.hdruk_metadata_col_omop AS target
# MAGIC USING (
# MAGIC   SELECT 
# MAGIC     table_name,
# MAGIC     column_name, 
...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE TABLE 1_inland.evan_demo.hdruk_metadata_tab_omop(
...
# MAGIC %sql
# MAGIC INSERT INTO 1_inland.evan_demo.hdruk_metadata_tab_omop
# MAGIC SELECT
# MAGIC   c.table_name,
# MAGIC   --CONCAT('[', array_join(collect_set(c.json_str), ','), ']'),
# MAGIC   collect_set(c.json_struct),
# MAGIC   NULL
# MAGIC FROM 1_inland.evan_demo.hdruk_metadata_col_omop AS c
...
# MAGIC %sql
# MAGIC
# MAGIC MERGE INTO 1_inland.evan_demo.hdruk_metadata_tab_omop AS target
# MAGIC USING (
...
api_path = "https://api.dev.hdruk.cloud/api/v1/integrations/datasets/1098"
headers = {
...
response = requests.get(
    "https://api.healthdatagateway.org/api/v1/datasets/1098",
    headers=headers
)
print(response)
...
'''
{
    ...
    "documentation": {
        "description": "Barts Health NHS OMOP Dataset",
