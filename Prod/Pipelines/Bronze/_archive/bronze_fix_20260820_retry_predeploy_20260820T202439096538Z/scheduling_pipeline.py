...
EXPECTED_COLUMNS = {
    SRC_EVENT: {"SCH_EVENT_ID", "APPT_TYPE_CD", "SCH_STATE_CD", "SCH_MEANING", "ENCNTR_ID", "REFERRAL_IDENT", "REFER_DT_TM", "UPDT_CNT", "ADC_UPDT"},
    SRC_PATIENT: {"SCH_EVENT_ID", "PERSON_ID", "ENCNTR_ID", "VERSION_DT_TM", "UPDT_CNT", "ADC_UPDT"},
    SRC_SCHEDULE: {"SCHEDULE_ID", "SCH_EVENT_ID", "SCHEDULE_SEQ", "SCH_STATE_CD", "BEG_EFFECTIVE_DT_TM", "INDIRECT_BOOK_IND", "UNCONFIRM_COUNT", "OVERRIDE_DURATION", "ADDITIONAL_MINUTES", "ADC_UPDT"},
...
def build_schedule(schedule_ids: DataFrame | None, decode_lookup: DataFrame) -> DataFrame:
    ...
    schedule = schedule.select(
        ...
        F.col("OVERRIDE_DURATION").cast("long").alias("OVERRIDE_DURATION_MINUTES"),
        F.col("ADDITIONAL_MINUTES").cast("long").alias("ADDITIONAL_MINUTES"),
