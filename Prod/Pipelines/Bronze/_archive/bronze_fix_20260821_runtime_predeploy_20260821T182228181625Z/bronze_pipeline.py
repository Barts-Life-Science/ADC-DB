...
# PowerForms now selects its write target through write_environment rather than
# target_schema. A successful Map dependency proves this cycle maintained the
# canonical lanes even when unchanged lanes have no fresh Delta commit.
_bronze_powerform_args = dict(
    _bronze_schema_refresh_args,
    write_environment=(
        "prod" if _bronze_target_schema.lower() == "4_prod.bronze" else "dev"
    ),
    run_mode="incremental",
    allow_stale_upstream="true",
)
...
_BRONZE_STEPS = [
    ...
    },
    {
        ...
        "enabled_default": True,
        "arguments": dict(_bronze_production_write_args, expect_idempotent="false"),
        "requires": [],
    ...
    },
    {
        ...
        # Fresh opt-in name intentionally ignores the persisted legacy widget that
        # triggered an unsafe stale-state incremental run on August 20, 2026.
        "enabled_widget": "run_powerform_incremental_after_full_recovery",
        "enabled_default": False,
        "arguments": _bronze_powerform_args,
    ...
    {
        "name": "allergy",
        "notebook": "allergy_pipeline",
        "enabled_widget": "run_allergy",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
    ...
    {
        "name": "research_study",
        "notebook": "research_study_pipeline",
        "enabled_widget": "run_research_study",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "maternity_msds",
        "notebook": "maternity_msds_pipeline",
        "enabled_widget": "run_maternity_msds",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "critical_care_medicus",
        "notebook": "critical_care_medicus_pipeline",
        "enabled_widget": "run_critical_care_medicus",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "critical_care_ccmds",
        "notebook": "critical_care_ccmds_pipeline",
        "enabled_widget": "run_critical_care_ccmds",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "neonatal",
        "notebook": "neonatal_pipeline",
        "enabled_widget": "run_neonatal",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "person_encntr_attribute",
        "notebook": "person_encntr_attribute_pipeline",
        "enabled_widget": "run_person_encntr_attribute",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "orders_spine",
        "notebook": "orders_spine_pipeline",
        "enabled_widget": "run_orders_spine",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "order_comment",
        "notebook": "order_comment_pipeline",
        "enabled_widget": "run_order_comment",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": ["orders_spine"],
        "timeout_seconds": 14400,
    },
    {
        "name": "radiology_event",
        "notebook": "radiology_event_pipeline",
        "enabled_widget": "run_radiology_event",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "identifier",
        "notebook": "identifier_pipeline",
        "enabled_widget": "run_identifier",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "parity_closure",
        "notebook": "parity_closure_pipeline",
        "enabled_widget": "run_parity_closure",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "episode",
        "notebook": "episode_pipeline",
        "enabled_widget": "run_episode",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "endobase_exam",
        "notebook": "endobase_exam_pipeline",
        "enabled_widget": "run_endobase_exam",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": ["endobase_pipeline"],
        "timeout_seconds": 14400,
    },
    {
        "name": "iweb_coronary",
        "notebook": "iweb_coronary_pipeline",
        "enabled_widget": "run_iweb_coronary",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": ["registry_pipeline"],
        "timeout_seconds": 14400,
    },
    {
        "name": "luna_eal",
        "notebook": "luna_eal_pipeline",
        "enabled_widget": "run_luna_eal",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": ["referral_rtt_pipeline"],
        "timeout_seconds": 14400,
    },
    {
        "name": "luna_cancer_ptl",
        "notebook": "luna_cancer_ptl_pipeline",
        "enabled_widget": "run_luna_cancer_ptl",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": ["referral_rtt_pipeline"],
        "timeout_seconds": 14400,
    ...
    {
        "name": "aria_staging",
        "notebook": "aria_staging_pipeline",
        "enabled_widget": "run_aria_staging",
        "enabled_default": False,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "pacs_text_bridge",
        "notebook": "pacs_text_bridge_pipeline",
        "enabled_widget": "run_pacs_text_bridge",
        "enabled_default": False,
        "arguments": _bronze_new_feed_args,
        "requires": ["pacs_pipeline"],
        "timeout_seconds": 14400,
    },
    {
        "name": "dicom_tag",
        "notebook": "dicom_tag_pipeline",
        "enabled_widget": "run_dicom_tag",
        "enabled_default": False,
        "arguments": _bronze_new_feed_args,
        "requires": [],
        "timeout_seconds": 14400,
    ...
    {
        "name": "pathology_expansion",
        "notebook": "pathology_expansion_pipeline",
        "enabled_widget": "run_pathology_expansion",
        "enabled_default": True,
        "arguments": _bronze_new_feed_args,
        "requires": ["map_pipeline"],
