...
# COMMAND ----------
#
# Finalization stays inside _map_common so nested %run module boundaries do
# not leak private implementation symbols into this orchestration notebook.
dbutils.notebook.exit(finalize_map_pipeline_run())
