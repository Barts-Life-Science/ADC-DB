...
_MAP_SPLIT_GROUP = 'map_20_clinical'
_MAP_SPLIT_ALLOWED_COMPONENTS = ['map_diagnosis', 'map_problem', 'map_med_admin', 'map_procedure', 'map_death']
...
if _map_split_component_selected('map_diagnosis'):
...
if _map_split_component_selected('map_problem'):
...
if _map_split_component_selected('map_med_admin'):
...
if _map_split_component_selected('map_procedure'):
...
if _map_split_component_selected('map_death'):
