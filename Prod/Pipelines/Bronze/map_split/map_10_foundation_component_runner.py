...
_MAP_SPLIT_GROUP = 'map_10_foundation'
_MAP_SPLIT_ALLOWED_COMPONENTS = ['map_address', 'map_person', 'map_care_site', 'map_medical_personnel', 'map_encounter']
...
if _map_split_component_selected('map_address'):
...
if _map_split_component_selected('map_person'):
...
if _map_split_component_selected('map_care_site'):
...
if _map_split_component_selected('map_medical_personnel'):
...
if _map_split_component_selected('map_encounter'):
