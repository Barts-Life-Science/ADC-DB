...
def patient_demographics_incr():
    max_adc_updt = get_max_adc_updt("8_dev.rde_3.rde_patient_demographics")
...
def encounter_incr():
    max_adc_updt = get_max_adc_updt("8_dev.rde_3.rde_encounter")
...
def ariapharmacy_incr():
    max_adc_updt = get_max_adc_updt("8_dev.rde_3.rde_ariapharmacy")
