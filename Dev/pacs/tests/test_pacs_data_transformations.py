...
def test_transformExamAccessionNumber():
    ...
    schema = StructType([ \
        ...
        StructField("ExaminationDicomStudyId", StringType(), True), \
        StructField("ExaminationAccessionNumber", StringType(), True), \
        StructField("Expected_ExaminationAccessionNumber", StringType(), True), \
        StructField("ExpectedTransformationDescription", StringType(),  True)
    ])

    data = [
        ('UKWXH00000123456', 'XCHES', 'VALUE_TOO_LONG', None, 'Mark as missing'),
        ('1234567', '1234567', 'VALUE_TOO_LONG', None, 'Mark as missing'),
        ...
        ('0', '1.00', '1.000', '1.00', 'Remove appended ExaminationIdString'),
        ('0', None, '12345670', '1234567', 'Remove appended ExaminationIdString'),
        ...
        ('0A', None, 'RNJ000012345670A', 'RNJ00001234567', 'Remove appended ExaminationIdString'),
        ...
        ('01', None, 'RNH0XR1234567801', 'RNH0XR12345678', 'Remove appended ExaminationIdString'),
        ...
        ('123456', None, '123456123456', '123456', 'Remove appended ExaminationIdString'),
        ('123456', '41234', '123456123456', '123456', 'Remove appended ExaminationIdString'),
        ('00123456', None, '0012345600123456', '00123456', 'Remove appended ExaminationIdString'),
        ('123456789123456', '1', '1234567891234561', None, 'Mark as missing'),
        ('19123456', '3123', '191234563123', None, 'Mark as missing when ExaminationIdString is the correct accession number')
    ]
